...
class M_perpus extends CI_Model{
	...
	{
		$sql -"inset into detail_pinjam (id_pinjam,id_buku,denda) select orderan.id_pinjam,orderan.id_buku,orderan.denda from orderanwhere orderan.id_anggota='$where'";
		$this->db->query($sql);
	}
